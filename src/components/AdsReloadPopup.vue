<template>
  ...
  >
    ...
    <div
      :class="[
        'bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-2xl max-h-[68vh] flex flex-col transform transition-all duration-300',
        { 'scale-100 opacity-100': showContent, 'scale-95 opacity-0': !showContent },
      ]"
      id="popupContent"
    >
      <!-- Header cố định -->
        ...
        <div class="p-6 space-y-6">
          ...
          <div class="space-y-4">
            ...
            <div class="bg-blue-50 dark:bg-gray-900/50 rounded-lg p-4 space-y-4">
              <!-- Tải toàn bộ -->
              <div
                class="bg-white dark:bg-gray-700/50 rounded-lg p-3 border border-blue-200 dark:border-blue-800"
              >
                ...
                <div class="pl-7 mt-1">
                  <p class="relative pl-5 text-xs text-gray-500 dark:text-gray-400">
                    <span
                      class="absolute left-0 top-1.5 w-3 h-px bg-gray-300 dark:bg-gray-600"
                    ></span
                    ><span
                      class="absolute left-0 -top-0.5 w-px h-3 bg-gray-300 dark:bg-gray-600"
                    ></span
              ...
              <!-- Tải theo ID -->
              <div
                class="bg-white dark:bg-gray-700/50 rounded-lg p-3 border border-gray-200 dark:border-gray-700"
              >
                <label class="flex items-center space-x-3 cursor-pointer">
                  <input
                    type="radio"
              ...
              >
                ...
                <div class="pl-7 mt-1">
                  <p class="relative pl-5 text-xs text-gray-500 dark:text-gray-400">
                    ...
                    ><span
                      class="absolute left-0 -top-0.5 w-px h-3 bg-gray-300 dark:bg-gray-600"
                    ></span
                    >Chọn từ danh sách Business Manager
                  </p>
                </div>
                <div v-if="loadMethod === 'byBm'" id="bmSelectContainer" class="mt-3">
                  <div class="flex space-x-2">
                    ...
                    <button
                      id="loadBmBtn"
                      class="px-4 py-2 text-sm bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-200 dark:bg-blue-900/50 dark:text-blue-300 dark:hover:bg-blue-800/60 transition-colors font-medium"
                    >
                      Load BM
                    </button>
                  </div>
          ...
          <div class="space-y-4">
            ...
            <div class="bg-blue-50 dark:bg-gray-900/50 rounded-lg p-4 space-y-4">
              ...
              <div class="grid grid-cols-2 gap-3">
                ...
                <div
                  class="bg-white dark:bg-gray-700/50 rounded-lg p-3 border border-gray-200 dark:border-gray-700 cursor-pointer flex items-center justify-between"
                  @click="hiddenAccounts = !hiddenAccounts"
                >
                  <label for="hiddenAccountsCheckbox" class="cursor-pointer">
                    ...
                    <span class="text-xs text-gray-500 dark:text-gray-400 block"
                      >Bao gồm tài khoản ẩn</span
                    >
                  </label>
                  <input
                    type="checkbox"
                    id="hiddenAccountsCheckbox"
                    v-model="hiddenAccounts"
                    @click.stop
                ...
                <div
                  class="bg-white dark:bg-gray-700/50 rounded-lg p-3 border border-gray-200 dark:border-gray-700 cursor-pointer flex items-center justify-between"
                  @click="includePayment = !includePayment"
                >
                  <label for="paymentCheckbox" class="cursor-pointer">
                    ...
                    >
                    <span class="text-xs text-gray-500 dark:text-gray-400 block"
                      >Bao gồm thông tin thanh toán</span
                    >
                  </label>
                  <input
                    type="checkbox"
              ...
              <div class="border-t border-gray-200 dark:border-gray-700 pt-4">
                <div class="flex items-center justify-between">
                  ...
                  <input
                    ...
                    min="1"
                    max="10000"
                    class="w-24 px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-center dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200"
                  />
                </div>
              </div>
            </div>
          ...
          <div class="flex space-x-3 pt-2">
            <button
              @click="loadData"
              id="loadDataBtn"
              class="flex-1 bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-3 px-4 rounded-lg font-medium hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
            >
              Tải dữ liệu
            </button>
            <button
              @click="close"
              id="cancelBtn"
              class="px-6 py-3 border border-gray-300 text-gray-700 rounded-lg font-medium hover:bg-gray-50 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-700 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
            >
              Hủy bỏ
            </button>
          </div>
      ...
      <div
        ...
        class="hidden px-6 pb-6 flex-shrink-0 dark:bg-gray-800 rounded-b-xl"
      >
        <div class="bg-gray-200 dark:bg-gray-700 rounded-full h-2 overflow-hidden">
          <div
            id="progressBar"
            class="bg-gradient-to-r from-blue-600 to-indigo-600 h-full transition-all duration-300 ease-out"
            style="width: 0%"
          ></div>
        </div>
