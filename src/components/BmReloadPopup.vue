<template>
  ...
  >
    ...
    <div
      :class="[
        'bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-2xl max-h-[80vh] flex flex-col transform transition-all duration-300',
            ...
            <div class="bg-blue-50 dark:bg-gray-900/50 rounded-lg p-4 space-y-4">
              ...
              <div class="border-t border-gray-200 dark:border-gray-700 pt-4 space-y-4">
                ...
                <div class="flex items-center justify-between">
                  <div class="flex flex-col">
                    <label class="text-sm font-medium text-gray-700 dark:text-gray-200"
                      >Lấy trạng thái</label
                    >
                    <span class="text-xs text-gray-500 dark:text-gray-400"
                      >Lấy trạng thái của tài khoản</span
                    >
                  </div>
                  <select
                    id="statusSelect"
...
const loadData = () => {
  const selectedOptions = dataOptions.value.reduce(
    (acc, option) => {
